...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            dialogFragmentInfApk dFragment1 = new dialogFragmentInfApk();
            dFragment1.show(fm, "");

        } else if (id == R.id.nav_gallery) {

            dialogFragmentPicasso dFragment2 = new dialogFragmentPicasso();
            dFragment2.show(fm, "");

        } else if (id == R.id.nav_slideshow) {

            dialogFragmentPicassoSlider dFragment3 = new dialogFragmentPicassoSlider();
            dFragment3.show(fm, "");
